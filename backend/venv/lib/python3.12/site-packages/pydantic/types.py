...
class Tag:
    ...
    def get_discriminator_value(v: Any) -> str:
        if isinstance(v, dict):
            return v.get('Item', v.get('filling'))
        return getattr(v, 'Item', getattr(v, 'filling', None))
    ...
    apple_variation = ThanksgivingDinner.model_validate(
        {'dessert': {'Item': 'apple', 'time_to_cook': 60, 'num_ingredients': 8}}
    )
    print(repr(apple_variation))
    '''
    ThanksgivingDinner(dessert=ApplePie(time_to_cook=60, num_ingredients=8, Item='apple'))
    '''
